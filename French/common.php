...
'BBerr pcre'						=>	'(%s) Le message est trop long ou complexe. Merci de le réduire.',			// Error 1
'BBerr unexpected attribute'		=>	'Attribut inattendu: "%1$s". (Pas d\'attribut autorisé pour (%2$s).',	// Error 2
'BBerr unrecognized attribute'		=>	'Attribut non reconnu: "%1$s", n\'est pas valide pour for (%2$s).',			// Error 3
'BBerr bbcode attribute'			=>	'Les attributs ne peuvent PAS contenir de BBCode',				// Error 4
'BBerr missing attribute'			=>	'(%1$s) n\'a pas tous les arguments requis.',							// Error 5
'BBerr nesting overflow'			=>	'(%1$s) : Profondeur d\'imbrication de : %2$d excède la limite autorisée: %3$d.',	// Error 6
'BBerr self-nesting'				=>	'(%s) a été ouvert dans lui-même, ceci n\'est pas autorisé.',				// Error 7
'BBerr invalid nesting'				=>	'(%1$s) a été ouvert dans (%2$s), ceci n\'est pas autorisé.',			// Error 8
'BBerr invalid parent'				=>	'(%1$s) ne peut pas être dans: (%2$s). Tags parents possibles: %3$s.',	// Error 9
'BBerr Invalid URL name'			=>	'URL invalide: %s',												// Error 10
'BBerr Invalid email address'		=>	'Adresse email invalide: %s',										// Error 10c
'BBerr Invalid color'				=>	'Couleur invalide: %s',										// Error 11
'BBerr invalid content'				=>	'Contenu invalide, (%s) requiert du contenu spécifique.',					// Error 12
'BBerr bad meta data'				=>	'Impossible de charger l\'image à partir de cette URL: %s',				// Error 13
'BBerr no file size'				=>	'Impossible de déterminer la taille du fichier distant.',							// Error 14
'BBerr non image'					=>	'L\' URL distante n\'a pas de Content-Type: "image".',					// Error 15
'BBerr bad http response'			=>	'Mauvaise réponse du header HTTP: "%s"',									// Error 16
'BBerr bad headers'					=>	'Impossible de lire les headers HTTP de l\'image.',						// Error 17
'BBerr orphan close'				=>	'Tag de fermeture orphelin: (/%s) n\'a pas d\'ouverture',					// Error 18
'BBerr orphan open'					=>	'Tag d\'ouverture orphelin: (%s) n\'a pas de fermeture.',					// Error 19

'BBmsg big image'					=>	'Image trop grande',														// Msg 1
'BBmsg images disabled'				=>	'Les images sont désactivées',				// Msg 2
